...
#define MKTYPE2_I(NAME) pyorb##_##NAME##_specials(); if (!to_ok(&pyorb##_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) MKTYPE2_I(NAME)
#define MKTYPE2_I(NAME) pyorb##_##NAME##_specials(); if (!to_ok(&pyorb##_##NAME##_Type)) return
#endif

#define MODULE_PREFIX pyorb
...
#include QUOTEME(build/pyorb_generated_include.h)
...
#define PYOPENCV_TO  pyorb_to
#define PYOPENCV_FROM  pyorb_from
...
#include QUOTEME(build/pyorb_generated_types.h)

#include QUOTEME(build/pyorb_generated_funcs.h)
...
#include QUOTEME(build/pyorb_generated_ns_reg.h)
...
#include QUOTEME(build/pyorb_generated_type_reg.h)
...
#include QUOTEME(build/pyorb_generated_type_publish.h)
