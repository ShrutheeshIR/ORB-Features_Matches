...
#define MKTYPE2_I(NAME) pyorb_matcher##_##NAME##_specials(); if (!to_ok(&pyorb_matcher##_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) MKTYPE2_I(NAME)
#define MKTYPE2_I(NAME) pyorb_matcher##_##NAME##_specials(); if (!to_ok(&pyorb_matcher##_##NAME##_Type)) return
#endif

#define MODULE_PREFIX pyorb_matcher
...
#include QUOTEME(build/pyorb_matcher_generated_include.h)
...
#define PYOPENCV_TO  pyorb_matcher_to
#define PYOPENCV_FROM  pyorb_matcher_from
...
#include QUOTEME(build/pyorb_matcher_generated_types.h)

#include QUOTEME(build/pyorb_matcher_generated_funcs.h)
...
#include QUOTEME(build/pyorb_matcher_generated_ns_reg.h)
...
#include QUOTEME(build/pyorb_matcher_generated_type_reg.h)
...
#include QUOTEME(build/pyorb_matcher_generated_type_publish.h)
